...
import BrailleMusicPaginator from '../modules/BrailleMusicPaginator';
...
class BrailleView extends React.Component {
  ...
  constructor(props) {
    ...
    this.paginator = new BrailleMusicPaginator();
  ...
  HandleDownload() {
    ...
    let ptcloud = geom.BraillePageToGeom(this.paginator.getPage(this.state.page), 0.5, 2);
