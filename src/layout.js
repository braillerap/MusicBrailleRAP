          ...
          <header>
            <div className='pure-g'>
              ...
              <div className='pure-u-3-5  headermain'>
                ...
                <a href="https://www.braillerap.org" target="_blank"><span className="pure-menu-heading">BrailleRAP Music</span></a>
                  <nav>
                    <ul className="pure-menu-list" >
                      
                      <li className="pure-menu-item">
                        <Link to="/" className="pure-menu-link" onClick={this.onClickMenu}>
                          
                          <FormattedMessage id="layout.music" defaultMessage="Music"/>
                        </Link>
                      </li>
                      <li className="pure-menu-item">
